...
========================================================================================
                         nf-core/chip
========================================================================================
 c-guzman/csrna Analysis Pipeline.
...
def create_workflow_summary(summary) {
    ...
    yaml_file.text  = """
    id: 'nf-core-chip-summary'
    description: " - this information is collected when the pipeline is started."
    section_name: 'c-guzman/csrna Workflow Summary'
    section_href: 'https://github.com/c-guzman/csrna'
    plot_type: 'html'
    data: |
...
process bamcoverage {
    ...
    input:
    file bam from bt2_bams_bc
    file bam_index from bt2_indexes_bc
...
workflow.onComplete {
    ...
    if (params.email) {
        try {
          ...
          log.info "[nf-core/chip] Sent summary e-mail to $params.email (sendmail)"
        } catch (all) {
          // Catch failures and try with plaintext
          [ 'mail', '-s', subject, params.email ].execute() << email_txt
          log.info "[nf-core/chip] Sent summary e-mail to $params.email (mail)"
        }
    }
    ...
    log.info "[nf-core/chip] Pipeline Complete"
